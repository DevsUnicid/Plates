...
// void imprimePick(Sprato *cardAtual) {
//     printf("|| # %d\n", cardAtual->pratoId);
...
// Sprato *menuPick(Sprato *boosterAtual, int numBooster) {
//     Sprato *cardAtual = boosterAtual;
//     int escolhaUsuario;
...
//     return buscaPratoPorId(boosterAtual, escolhaUsuario);
// }

// bool sistemaBusca(Sprato *cardapio) {
...
//             scanf("%99[^\t\n]", nomeCardBuscado);
//             getchar();
//             pratoAux = buscaPratoPorNome(cardapio, nomeCardBuscado);

//             if (pratoAux == NULL) {
//                 printf("Infelizmente, não encontrei o card com o nome\n\n\t%s \n\nTente novamente.\n\n", nomeCardBuscado);
//                 escolhaUsuario = NULL;
//             }
//             else imprimeCardaprio(pratoAux, false);
//             escolhaUsuario = NULL;
//             break;
...
//             getchar();
//             pratoAux = buscaCardPorCor(cardapio, corCardBuscado);
...
//             pratoAux = buscaCardPorCMC(cardapio, cmcEscolhido);
